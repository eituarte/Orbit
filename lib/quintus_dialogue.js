var quintusDialogue = function(Quintus) {
    ...
    Quintus.Dialogue = function(Q) {
        ...
        // be shown
        //Q.Dialogue.MARGIN = 0; // Left margin of the dialogue box
        //Q.Dialogue.HEIGHT = 0; // Height of the dialogue box
        //Q.Dialogue.WIDTH = 0; // Width of the dialogue box
        Q.Dialogue.COLOR = "black"; // Background color of the boxes
        ...
        Q.Sprite.extend('Character', {
            init: function(p) {
                ...
                Q.state.on("change.image", function() {
                    ...
                    obj.matrix.scale(
                        1 / (obj.p.w / (Q.width * 1 / 4 - 28)),
                        1 / (obj.p.h / (Q.height * 1 / 4)));
                });
            }
        });
         ...
         * and the name of character who is speaking
...
const dialogue = {
    conversacion1: [{
        name: "Javier",
        sprite: "1.png",
        text: "Hola tio, que tal?\nEl comandante exige un informe del estado del juegOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOo"
    }, {
        sprite: "2.png",
        text: "Bien tio"
    }, {
...
function processDialog(conversation) {
    conv = conversation;
    var text = this.p.label.split("\n");

    for (var i = 0; i < this.splitLabel.length; i++) {
        var lineWidth = (Q.ctx.measureText(this.splitLabel[i])).width;
        if (lineWidth > this.p.w) {
            p.w = metrics.width;
        }
    }
}*/
